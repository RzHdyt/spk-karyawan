                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card card-block">
                                ...
                                <div class="card-title-block">
                                    <h3 class="title">Data Kriteria</h3>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="project-actions ">
                                                        ...
                                                        <a class="btn btn-danger btn-sm" href="javascript:void(0)"
                                                            onclick="if(confirm('Are you sure you want to delete this employee?')) $('#deleteForm-{{$kriteria->id}}').submit()">
                                                            <i class="fa fa-trash"></i>
                                                            Delete
                                                        </a>
                                                        <form
                                                            action="{{ route('admin.kriteria.destroy', [$kriteria->id]) }}"
