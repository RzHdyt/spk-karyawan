<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('assets/img/wd-logo.png') }}" width="60" height="30"
            alt="SPK-TOPSIS">
        <img class="navbar-brand-minimized" src="{{ asset('assets/img/wd-logo.png') }}" width="40" height="20"
            alt="WarungData-Logo">
    </a>
