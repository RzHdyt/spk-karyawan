...
class PerhitunganTopsisController extends Controller
{
    ...
    {
        $karyawans =
            DB::select('SELECT DISTINCT karyawans.id, karyawans.nik, karyawans.name, karyawans.status FROM penilaians JOIN karyawans ON penilaians.karyawan_id = karyawans.id');
